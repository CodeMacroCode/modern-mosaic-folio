...
const projects = [
  {
    ...
    description:
      "A modern e-commerce solution built with React and TypeScript, featuring advanced filtering, cart management, and payment integration.",
  ...
  },
  {
    ...
    description:
      "A minimalist portfolio website for a creative agency, emphasizing clean typography and smooth animations.",
  ...
  },
  {
    ...
    description:
      "A comprehensive food delivery platform with restaurant management, order tracking, and payment processing.",
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            A curated collection of recent work showcasing my approach to modern
